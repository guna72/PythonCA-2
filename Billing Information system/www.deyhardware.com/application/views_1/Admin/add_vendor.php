 ...
 <?php if( $this->session->flashdata('feedback1')){?>        
  ...
  <fieldset>
    ...
    <div class="form-group"><?php echo form_label('IFSC Code','ifsc_code',['class'=>'col-lg-2 col-md-2 control-label']);?><div class="col-lg-6 col-md-6">
      ...
      <div class="form-group"><?php echo form_label('Bank Address','bank_address',['class'=>'col-lg-2 col-md-2 control-label']);?><div class="col-lg-6 col-md-6">
         <?php echo form_input(['class'=>'form-control','name'=>'bank_address','required','placeholder'=>'Enter Bank Address']);?>
      </div>
      <div class="col-lg-4 col-md-4"><?php echo  form_error('ifsc_code',"<p class='text-danger'>","</p>");?>
      </div>
    </div>

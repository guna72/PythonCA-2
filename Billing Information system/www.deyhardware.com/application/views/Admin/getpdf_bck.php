...
$table.='<tr  style="text-align:center">
         ...
         foreach($data2 as $row1)
         {
         	$table.='<tr style="text-align:center">
               ...
               <td style="border: 1px solid #000">'.$row1->sac.'</td>
               <td colspan="2" style="border: 1px solid #000">'.$row1->product_name.'</td>
...
$table.='<tr style="text-align:center">
 ...
 $table.='<tr style="text-align:center">
             ...
             <td colspan="2" style="border:1px solid #000"><b> </b>'.round($total1).'</td>
...
$table.='<tr style="text-align:center">
             ...
             <td colspan="2" style="border:1px solid #000"><b> </b>'.round($total2).'</td>
...
$table.='<tr style="text-align:center">
             ...
             <td colspan="2" style="border:1px solid #000"><b>'.round($grand_total).'/-</b></td>

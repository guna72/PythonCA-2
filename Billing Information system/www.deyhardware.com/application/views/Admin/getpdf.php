...
$date;
  ...
  $payment_mode;
    foreach ($data2 as $row) {
	   ...
	   if($row->active==0)
		{   
			$invoice_no=$row->con_chanal_no;
	   }else
     {   
      $invoice_no=$row->con_invoice_no;
     }
...
$table='<table  style="padding:0px 10px ; text-align:left">
       ...
       <td colspan="2" style="border-right: 1px solid #000;border-bottom: 1px solid #000; "><b>GSTIN(IF ANY): </b>'.$data1->customer_gstin.'</td>
       </tr>
...
$table.='<tr  style="text-align:center">
            ...
            <th colspan="2" style="border:1px solid #000"><b>PRD CODE</b></th>
            <th colspan="3" style="border:1px solid #000"><b>PRD DESC</b></th>
         ...
         foreach($data2 as $row1)
         {
         	$table.='<tr style="text-align:center">
               ...
               <td colspan="3" style="border: 1px solid #000">'.$row1->product_name.'</td>
...
$table.='<tr style="text-align:center">
             ...
             <td colspan="3" style="border:1px solid #000"><b>'.$total_.'</b></td>
        </tr>';
...
$table.='<tr style="text-align:center">
             ...
             <td colspan="3" style="border:1px solid #000"><b></b>'.$total_discount.'</td>
 ...
 $table.='<tr style="text-align:center">
             ...
             <td colspan="5" style="border:1px solid #000"><b>SGST :'.$sgst.' % </b></td>
             <td colspan="3" style="border:1px solid #000"><b> </b>'.round($total1).'</td>
...
$table.='<tr style="text-align:center">
             ...
             <td colspan="3" style="border:1px solid #000"><b> </b>'.round($total2).'</td>
...
$table.='<tr style="text-align:center">
             ...
             <td colspan="3" style="border:1px solid #000"><b>'.round($grand_total).'/-</b></td>
        ...
        if(!empty($data3))
        {
            $table.='<tr style="text-align:center">
             ...
             <td colspan="3" style="border:1px solid #000"><b>'.$data3->payment.'/-</b></td>
        ...
        if($data3->payment != $data3->total)
        {
         $table.='<tr style="text-align:center">
             ...
             <td colspan="3" style="border:1px solid #000"><b>'.($data3->total-$data3->payment).'/-</b></td>
...
$table.='<tr>
            <td>*It is a computer generated bill thus require no signature.(For Dey Hardware)</td>
         </tr>';
$table.='</table>';
...
$table.='<tr>
            <td>4.  Jaquar Customer Care No. : 1800 121 6808(Toll Free).</td>
         </tr>';

  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="form-group" style="display:none">
       '.form_label("<span>* </span> Product Code","Product Code",["class"=>' control-label']).'
      <div class="">'.form_input(['class'=>'form-control','name'=>'product_code_old','placeholder'=>'Product Code','value'=>$row->sac]).'</div>
      <div class="">'.form_error('product_code_old',"<p class='text-danger'>","</p>").'</div>
      </div>

...
<div class="dashboard">
 ...
 <?php } if( $this->session->flashdata('feedback2'))
  ...
  <fieldset>
    ...
    <div class="form-group"><?php echo form_label('<span>* </span> Product Name','Product Name',['class'=>'col-lg-2 col-md-2 control-label']);?><div class="col-lg-6 col-md-6">
         <?php echo form_input(['class'=>'form-control','name'=>'product_name','placeholder'=>'Product Name'])?>
      </div>

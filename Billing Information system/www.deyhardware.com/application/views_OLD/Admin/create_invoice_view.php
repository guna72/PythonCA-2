...
$('.show_table').click(function(){
  ...
  while(count<str.length){
    $('#tbdy').append(`<tr>
      ...
      <td>`+$('.igst'+str.charAt(count)).val()+`</td>
    </tr>`);
    count++;
    count_fun++;
  }
     ...
     ?>
      ...
      <div class="modal-body">
        <table class="table table-striped table-hover ">
          ...
          if($igst==0)
        {
         $total1=($all_total*$cgst)/100 ;
         $total2=($all_total*$sgst)/100 ;
         $all_total=$all_total+$total1+$total2;
       }
       else
       {
         $total1=($all_total*$igst)/100;
 ...
 <form class="form-horizontal bkd" action="" method="post">
  <fieldset>
   ...
   <?php echo  form_error('address',"<p class='text-danger'>","</p>");?>
    ...
    <div class="form-group">
    <?php echo form_label('Customer GSCIN','customer_gst',['class'=>'col-lg-2 col-md-2 control-label']);?>
    <div class="col-lg-6 col-md-6">
...
<div class="form-group"><?php echo form_label('<span>* </span> QUENTITY','qnty0',['class'=>'col-lg-2 col-md-2 control-label']);?>
<div class="col-lg-6 col-md-6">
 <?php echo form_input(['class'=>'form-control qnty0','name'=>'qnty0','type'=>'number','placeholder'=>'QUENTITY']);?>
</div>
<div class="col-lg-4 col-md-4">
...
<div class="form-group">
  <div class="col-lg-10 col-lg-offset-2">
    <?php echo form_button(['class'=>'btn btn-primary add control-label','type'=>'button','name'=>'add','content'=>'More ff'])?>
  </div>
</div>

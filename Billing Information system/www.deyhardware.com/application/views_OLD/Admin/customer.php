        ...
        foreach ($invoice_details as $row) {
         	...
         	echo form_open('admin/'.$pdf_link.'/'.$row->ph_no.'/'.$row->date.'/'.$row->no_invoice_day,['target'=>'_blank'])."<tr class=".$class.">
                   ...
                   <td  colspan='3' name='com_name'>".$row->customer_name."</td>
         	       <td name='des'>".$row->product_name."</td>
                   <td name='sac'>".$row->sac."</td>
                   <td name='sac'>".$row->qunty."</td>
                   <td name='gw'>".$row->cgst."%</td>
                   <td name='nw'>".$row->sgst."%</td>
                   <td name='nw'>".$row->igst."%</td>
                   <td name='cgst'>".$row->date."</td>
                   <td name='sgst'>".$row->grand_total_not_gst."/-</td>
                   <td name='igst'>".$row->payment."/-</td>
